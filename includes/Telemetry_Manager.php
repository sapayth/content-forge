...
class Telemetry_Manager
{
	...
	public static function custom_telemetry_notice()
	{
		...
		<div class="updated">
			...
			<p class="submit">
				&nbsp;<a href="<?php echo esc_url( $opt_in_url ); ?>" class="button-primary button-large"><?php esc_html_e( 'Allow', 'content-forge' ); ?></a>&nbsp;
				<a href="<?php echo esc_url( $opt_out_url ); ?>" class="button-secondary button-large"><?php esc_html_e( 'No thanks', 'content-forge' ); ?></a>
			</p>
		</div>
		<?php
	}
